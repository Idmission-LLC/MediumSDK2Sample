...
//    func show_PassportID_SelectionScreen(instance:UIViewController, serviceID:String) {
//        
//
//        //loading Passport-ID XIB into our view
//        let PassportIDSelectionCustomView = PassportIDSelection(frame: self.view.bounds, selectedSID: serviceID)
//        PassportIDSelectionCustomView.delegate = instance as? PassportIDSelectionDelegate
//        PassportIDSelectionCustomView.tag = 9
//        //animate addSubview
//        UIView.transition(with: self.view, duration: 0.5, options: [.transitionFlipFromLeft], animations: {
//            self.view.addSubview(PassportIDSelectionCustomView)
//        }, completion: nil)
//        self.view.addSubview(PassportIDSelectionCustomView)
//
//    }
